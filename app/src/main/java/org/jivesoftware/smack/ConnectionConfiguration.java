...
public abstract class ConnectionConfiguration {
     ...
     * the mode is {@link org.jivesoftware.smack.ConnectionConfiguration.SecurityMode#ifpossible}.
     *
    ...
    /**
     * Gets the custom SSLContext previously set with {@link org.jivesoftware.smack.ConnectionConfiguration.Builder#setCustomSSLContext(javax.net.ssl.SSLContext)} for
     ...
     * {@link org.jivesoftware.smack.SmackConfiguration#setDefaultHostnameVerifier(javax.net.ssl.HostnameVerifier)}.
     * 
     ...
     * default the value of {@link org.jivesoftware.smack.SmackConfiguration#DEBUG} is used.
     *
    ...
    /**
     * Returns true if a {@link org.jivesoftware.smack.packet.Session} will be requested on login if the server
     ...
     * @see org.jivesoftware.smack.ConnectionConfiguration.Builder#setLegacySessionDisabled(boolean)
     */
    @Deprecated
    ...
    public static abstract class Builder<B extends Builder<B, C>, C extends ConnectionConfiguration> {
        ...
        /**
         * Sets if a {@link org.jivesoftware.smack.packet.Session} will be requested on login if the server supports
