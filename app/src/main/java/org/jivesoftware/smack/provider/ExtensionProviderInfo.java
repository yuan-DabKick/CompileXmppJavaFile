...
/**
 * Defines the information required to register a stanza(/packet) extension Provider with the {@link org.jivesoftware.smack.provider.ProviderManager} when using the
 * {@link org.jivesoftware.smack.provider.ProviderLoader}.
 * 
