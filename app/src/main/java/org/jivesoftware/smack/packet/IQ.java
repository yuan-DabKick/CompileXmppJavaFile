...
public abstract class IQ extends Stanza {
    ...
    /**
     * Return true if this IQ is a request IQ, i.e. an IQ of type {@link org.jivesoftware.smack.packet.IQ.Type#get} or {@link org.jivesoftware.smack.packet.IQ.Type#set}.
     *
    ...
    /**
     * Convenience method to create a new empty {@link org.jivesoftware.smack.packet.IQ.Type#result IQ.Type.result}
     * IQ based on a {@link org.jivesoftware.smack.packet.IQ.Type#get IQ.Type.get} or {@link org.jivesoftware.smack.packet.IQ.Type#set IQ.Type.set}
     * IQ. The new stanza(/packet) will be initialized with:<ul>
     *      <li>The sender set to the recipient of the originating IQ.
     *      <li>The recipient set to the sender of the originating IQ.
     *      <li>The type set to {@link org.jivesoftware.smack.packet.IQ.Type#result IQ.Type.result}.
     *      <li>The id set to the id of the originating IQ.
     *      <li>No child element of the IQ element.
     * </ul>
     *
     * @param request the {@link org.jivesoftware.smack.packet.IQ.Type#get IQ.Type.get} or {@link org.jivesoftware.smack.packet.IQ.Type#set IQ.Type.set} IQ packet.
     * @throws IllegalArgumentException if the IQ stanza(/packet) does not have a type of
     *      {@link org.jivesoftware.smack.packet.IQ.Type#get IQ.Type.get} or {@link org.jivesoftware.smack.packet.IQ.Type#set IQ.Type.set}.
     * @return a new {@link org.jivesoftware.smack.packet.IQ.Type#result IQ.Type.result} IQ based on the originating IQ.
     */
    ...
    /**
     * Convenience method to create a new {@link org.jivesoftware.smack.packet.IQ.Type#error IQ.Type.error} IQ
     * based on a {@link org.jivesoftware.smack.packet.IQ.Type#get IQ.Type.get} or {@link org.jivesoftware.smack.packet.IQ.Type#set IQ.Type.set}
     * IQ. The new stanza(/packet) will be initialized with:<ul>
     *      <li>The sender set to the recipient of the originating IQ.
     *      <li>The recipient set to the sender of the originating IQ.
     *      <li>The type set to {@link org.jivesoftware.smack.packet.IQ.Type#error IQ.Type.error}.
     *      <li>The id set to the id of the originating IQ.
     ...
     * @throws IllegalArgumentException if the IQ stanza(/packet) does not have a type of
     *      {@link org.jivesoftware.smack.packet.IQ.Type#get IQ.Type.get} or {@link org.jivesoftware.smack.packet.IQ.Type#set IQ.Type.set}.
     * @return a new {@link org.jivesoftware.smack.packet.IQ.Type#error IQ.Type.error} IQ based on the originating IQ.
     */
