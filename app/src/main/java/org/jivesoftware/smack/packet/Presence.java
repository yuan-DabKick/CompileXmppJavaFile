 ...
 * <ul>
 *      <li>{@link org.jivesoftware.smack.packet.Presence.Type#available available} -- (Default) indicates the user is available to
 *          receive messages.
 *      <li>{@link org.jivesoftware.smack.packet.Presence.Type#unavailable unavailable} -- the user is unavailable to receive messages.
 *      <li>{@link org.jivesoftware.smack.packet.Presence.Type#subscribe subscribe} -- request subscription to recipient's presence.
 *      <li>{@link org.jivesoftware.smack.packet.Presence.Type#subscribed subscribed} -- grant subscription to sender's presence.
 *      <li>{@link org.jivesoftware.smack.packet.Presence.Type#unsubscribe unsubscribe} -- request removal of subscription to
 *          sender's presence.
 *      <li>{@link org.jivesoftware.smack.packet.Presence.Type#unsubscribed unsubscribed} -- grant removal of subscription to
 *          sender's presence.
 *      <li>{@link org.jivesoftware.smack.packet.Presence.Type#error error} -- the presence stanza(/packet) contains an error message.
 * </ul><p>
 *
 ...
 *      <li>Mode -- one of five presence modes: {@link org.jivesoftware.smack.packet.Presence.Mode#available available} (the default),
 *          {@link org.jivesoftware.smack.packet.Presence.Mode#chat chat}, {@link org.jivesoftware.smack.packet.Presence.Mode#away away}, {@link org.jivesoftware.smack.packet.Presence.Mode#xa xa} (extended away), and
 *          {@link org.jivesoftware.smack.packet.Presence.Mode#dnd dnd} (do not disturb).
 * </ul><p>
 *
...
public final class Presence extends Stanza implements TypedCloneable<Presence> {
    ...
    /**
     * Returns true if the {@link org.jivesoftware.smack.packet.Presence.Type presence type} is available (online) and
     ...
     * when the user is available, their presence mode may be {@link org.jivesoftware.smack.packet.Presence.Mode#away away},
     * {@link org.jivesoftware.smack.packet.Presence.Mode#xa extended away} or {@link org.jivesoftware.smack.packet.Presence.Mode#dnd do not disturb}. Use
     ...
     * type of {@link #available available}, even if the mode is {@link org.jivesoftware.smack.packet.Presence.Mode#away away},
     * {@link org.jivesoftware.smack.packet.Presence.Mode#dnd dnd}, etc. The presence type is only {@link #unavailable unavailable} when
