...
public final class Message extends Stanza implements TypedCloneable<Message> {
     ...
     * language (see {@link org.jivesoftware.smack.packet.Stanza#getDefaultLanguage()}).
     *
    ...
    public XmlStringBuilder toXML() {
        ...
        buf.optAttribute("type", typeToString(type));

        /** DabKick Additions**/
        if (mTags != null) {
            Iterator<Map.Entry<String, String>> it = mTags.entrySet().iterator();
            while (it.hasNext()) {
                Map.Entry pairs = (Map.Entry)it.next();
                String tag = (String) pairs.getKey();
                String value = (String) pairs.getValue();
                buf.optAttribute(tag,value);
            }
        }
    ...
    String typeToString(Type type) {
        ...
        if (Type.chat == type) {
            ...
            return "groupchat";
        } else if (Type.headline == type) {
            return "headline";
        } else if (Type.acknowledgement == type) {
            return "Acknowledgement";
        } else if (Type.entering == type) {
            return "Entering";
        } else if (Type.metooentering == type) {
            return "MeTooEntering";
        } else if (Type.photoacknowledgement == type) {
            return "PhotoAcknowledgement";
        } else if (Type.voicechat == type) {
            return "VoiceChat";
        } else if (Type.voicechatraw == type) {
            return "VoiceChatRaw";
        } else if (Type.subscribe == type) {
            return "subscribe";
        } else if (Type.unsubscribed == type) {
            return "unsubscribed";
        } else if (Type.photodelete == type) {
            return "PhotoDelete";
        } else if (Type.photo == type) {
            return "Photo";
        } else if (Type.songdetails == type) {
            return "SongDetails";
        } else if (Type.invitetolisten == type) {
            return "normal";
        } else if (Type.acceptedtolisten == type) {
            return "AcceptedToListen";
        } else if (Type.listening == type) {
            return "Listening";
        } else if (Type.stoplistening == type) {
            return "StopListening";
        } else if (Type.forcestoplistening == type) {
            return "ForceStopListening";
        } else if (Type.video == type) {
            return "Video";
        } else if (Type.videocontrol == type) {
            return "VideoControl";
        } else if (Type.invite == type) {
            return "Invite";
        } else if (Type.sentphotos == type) {
            return "SentPhotos";
        } else if (Type.dabping == type) {
            return "dabPing";
        } else if (Type.dabpong == type) {
            return "dabPong";
        } else if (Type.talking == type) {
            return "Talking";
        } else if (Type.endtalking == type) {
            return "EndTalking";
        } else if (Type.typing == type) {
            return "Typing";
        } else if (Type.endtyping == type) {
            return "EndTyping";
        } else if (Type.addingphotos == type) {
            return "AddingPhotos";
        } else if (Type.endaddingphotos == type) {
            return "EndAddingPhotos";
        } else if (Type.showingwebmedia == type) {
            return "ShowingWebMedia";
        } else if (Type.endshowingwebmedia == type) {
            return "EndShowingWebMedia";
        } else if (Type.searchingwebmedia == type) {
            return "SearchingWebMedia";
        } else if (Type.endsearchingwebmedia == type) {
            return "EndSearchingWebMedia";
        } else if (Type.usingcamera == type) {
            return "UsingCamera";
        } else if (Type.endusingcamera == type) {
            return "EndUsingCamera";
        } else if (Type.endgeneric == type) {
            return "EndGeneric";
        } else if (Type.generic == type) {
            return "Generic";
        } else if (Type.away == type) {
            return "Away";
        } else if (Type.endaway == type) {
            return "EndAway";
        } else if (Type.sendingphotos == type) {
            return "SendingPhotos";
        } else if (Type.endsendingphotos == type) {
            return "EndSendingPhotos";
        } else if (Type.checkingmail == type) {
            return "CheckingMail";
        } else if (Type.endcheckingmail == type) {
            return "EndCheckingMail";
        } else if (Type.result == type) {
            return "result";
        } else if (Type.disconnect == type) {
            return "Disconnect";
