...
public class XMPPTCPConnection extends AbstractXMPPConnection {
    ...
    public XMPPTCPConnection(XMPPTCPConnectionConfiguration config) {
        ...
        Log.d("yuan_socket", "XMPPTCPConnection init.");
    ...
    public synchronized void instantShutdown() {
        Log.d("yuan_socket","instantShutdown()");
    ...
    private void shutdown(boolean instant) {
        ...
        if (disconnectedButResumeable) {
            Log.d("yuan_socket", "disconnectedButResumeable.");
            return;
        }

        Log.d("yuan_socket", "private void shutdown(boolean instant)");
    ...
    private void connectUsingConfiguration() throws IOException, ConnectionException {
        ...
        if (socketFactory == null) {
            ...
            Log.d("yuan_socket","socketFactory is null. SocketFactory.getDefault().");
        }
        for (HostAddress hostAddress : hostAddresses) {
            ...
            try {
                ...
                while (inetAddresses.hasNext()) {
                    ...
                    try {
                        Log.d("yuan_socket","Trying to establish TCP connection to " + inetAddressAndPort);
    ...
    private synchronized void notifyConnectionError(Exception e) {
        ...
        Log.d("yuan_socket","notifyConnectionError:"+e.toString());
    ...
    protected void afterFeaturesReceived() throws SecurityRequiredException, NotConnectedException {
        ...
        if (startTlsFeature != null) {
            if (startTlsFeature.required() && config.getSecurityMode() == SecurityMode.disabled) {
                Log.d("yuan_socket","call notifyConnectionError:afterFeaturesReceived()");
...
//                },15000);
    ...
    protected class PacketWriter {
        ...
        void shutdown(boolean instant) {
            ...
            Log.d("yuan_socket", "void shutdown(boolean instant)");
