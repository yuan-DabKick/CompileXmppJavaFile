 ...
 * use than a {@link org.jivesoftware.smack.StanzaListener} when you need to wait for a specific
 * result.<p>
 *
 ...
 *
 * @see org.jivesoftware.smack.XMPPConnection#createPacketCollector(org.jivesoftware.smack.filter.StanzaFilter)
 * @author Matt Tucker
 */
public class PacketCollector {
     ...
     * @throws org.jivesoftware.smack.XMPPException.XMPPErrorException in case an error response.
     */
     ...
     * @return the next available packet.
     * @throws org.jivesoftware.smack.XMPPException.XMPPErrorException in case an error response.
     * @throws org.jivesoftware.smack.SmackException.NoResponseException if there was no response from the server.
     */
    ...
    public static class Configuration {
         ...
         * @deprecated use {@link #setStanzaFilter(org.jivesoftware.smack.filter.StanzaFilter)} instead.
         */
        @Deprecated
