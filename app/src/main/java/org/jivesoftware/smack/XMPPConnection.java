...
public interface XMPPConnection {
     ...
     * @deprecated use {@link #sendStanza(org.jivesoftware.smack.packet.Stanza)} instead.
     */
    @Deprecated
     ...
     * @throws org.jivesoftware.smack.SmackException.NotConnectedException if the connection is not connected.
     */
     ...
     * {@link org.jivesoftware.smack.filter.IQReplyFilter}, guaranteeing that stanza(/packet) id and JID in the 'from' address have
     * expected values.
     *
     ...
     * more suitable to use than a {@link org.jivesoftware.smack.StanzaListener} when you need to wait for
     * a specific result.
     * 
     ...
     * PacketCollector is more suitable to use than a {@link org.jivesoftware.smack.StanzaListener}
     * when you need to wait for a specific result.
     * <p>
     * <b>Note:</b> If you send a Stanza(/Packet) right after using this method, then
     * consider using
     * {@link #createPacketCollectorAndSend(org.jivesoftware.smack.filter.StanzaFilter, org.jivesoftware.smack.packet.Stanza)} instead.
     ...
     * {@link #createPacketCollector(org.jivesoftware.smack.filter.StanzaFilter)}.
     * </p>
     * 
     ...
     * {@link #addAsyncStanzaListener(org.jivesoftware.smack.StanzaListener, org.jivesoftware.smack.filter.StanzaFilter)} and
     * {@link #addSyncStanzaListener(org.jivesoftware.smack.StanzaListener, org.jivesoftware.smack.filter.StanzaFilter)} for more information.
     * </p>
     *
     * @param packetListener the stanza(/packet) listener to notify of new received packets.
     * @param packetFilter the stanza(/packet) filter to use.
     * @deprecated use {@link #addAsyncStanzaListener(org.jivesoftware.smack.StanzaListener, org.jivesoftware.smack.filter.StanzaFilter)} or
     *             {@link #addSyncStanzaListener(org.jivesoftware.smack.StanzaListener, org.jivesoftware.smack.filter.StanzaFilter)}.
     */
    @Deprecated
     ...
     * @deprecated use {@link #removeAsyncStanzaListener(org.jivesoftware.smack.StanzaListener)} or {@link #removeSyncStanzaListener(org.jivesoftware.smack.StanzaListener)}.
     */
    @Deprecated
     ...
     * response. Consider using {@link #addAsyncStanzaListener(org.jivesoftware.smack.StanzaListener, org.jivesoftware.smack.filter.StanzaFilter)} when possible, i.e. when
     ...
     * @param packetListener the stanza(/packet) listener to notify of new received packets.
     * @param packetFilter the stanza(/packet) filter to use.
     * @see #addPacketInterceptor(org.jivesoftware.smack.StanzaListener, org.jivesoftware.smack.filter.StanzaFilter)
     * @since 4.1
     */
     ...
     * <p>
     * Unlike {@link #addAsyncStanzaListener(org.jivesoftware.smack.StanzaListener, org.jivesoftware.smack.filter.StanzaFilter)} stanza(/packet) listeners added with this method will be
    ...
    */
     ...
     * 
     * <p>
     * NOTE: For a similar functionality on incoming packets, see {@link #addAsyncStanzaListener(org.jivesoftware.smack.StanzaListener, org.jivesoftware.smack.filter.StanzaFilter)}.
     *
     ...
     * {@link org.jivesoftware.smack.SmackException.NoResponseException} if no reply to a request was received within the timeout period.
     *
     ...
     *
     * @return the currently active {@link org.jivesoftware.smack.XMPPConnection.FromMode}
     */
     ...
     * with a {@link org.jivesoftware.smack.SmackException.NoResponseException}. The callback will be invoked at most once.
     * </p>
     * 
     * @param stanza the stanza to send (required)
     * @param replyFilter the filter used to determine response stanza (required)
     ...
     * error as {@link org.jivesoftware.smack.XMPPException.XMPPErrorException}. If there is no response after the
     * connections default reply timeout, then <code>exceptionCallback</code> will be invoked with a
     * {@link org.jivesoftware.smack.SmackException.NoResponseException}.
     * 
     * @param iqRequest the IQ stanza to send (required)
     * @param callback the callback invoked if there is result response (required)
     * @param exceptionCallback the callback invoked if there is an Exception optional
     ...
     * {@link org.jivesoftware.smack.packet.IQ.Type#result} with that result IQ. If there is an
     * error response <code>exceptionCallback</code> will be invoked, if not null, with the received
     * error as {@link org.jivesoftware.smack.XMPPException.XMPPErrorException}. If there is no response after
