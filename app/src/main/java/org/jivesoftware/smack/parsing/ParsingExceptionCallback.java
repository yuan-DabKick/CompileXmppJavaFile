 ...
 * stanza that caused the parsing error by using the getContent() (for example {@link org.jivesoftware.smack.parsing.UnparsablePacket#getContent()})
 * method.
 * 
 * Smack provides 2 predefined ParsingExceptionCallback's: {@link org.jivesoftware.smack.parsing.ExceptionLoggingCallback} and {@link ExceptionThrowingCallback}.
 * 
