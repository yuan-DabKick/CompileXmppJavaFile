...
public class SmackException extends Exception {
     ...
     * {@link org.jivesoftware.smack.SmackException.ConnectionException#getFailedAddresses()}, which will have the exception causing the
     * connection failure set and retrievable with {@link org.jivesoftware.smack.util.dns.HostAddress#getException()}.
     */
