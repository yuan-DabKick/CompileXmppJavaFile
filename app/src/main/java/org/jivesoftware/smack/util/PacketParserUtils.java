...
public class PacketParserUtils {
    ...
    public static Message parseMessage(XmlPullParser parser)
        ...
        if (message.mTags != null) {
            for (int i=0; i<Stanza.parseTags.size(); i++) {
                String tag = Stanza.parseTags.get(i);
     ...
     * @throws org.xmlpull.v1.XmlPullParserException if parser encounters invalid XML
     ...
     * @throws org.xmlpull.v1.XmlPullParserException if an exception occurs while parsing the stanza.
     */
     ...
     * @throws org.xmlpull.v1.XmlPullParserException if an exception occurs while parsing the packet.
     * @throws SmackException 
     */
    ...
    /**
     * @deprecated use {@link #parseExtensionElement(String, String, org.xmlpull.v1.XmlPullParser)} instead.
     */
    @Deprecated
