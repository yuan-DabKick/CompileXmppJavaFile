 ...
 *  <li>{@link #authenticate(String, String, javax.security.auth.callback.CallbackHandler)} -- Initiate authentication stanza
...
public abstract class SASLMechanism implements Comparable<SASLMechanism> {
     ...
     * {@link #authenticate(String, String, javax.security.auth.callback.CallbackHandler)} whenever possible.
     * 
